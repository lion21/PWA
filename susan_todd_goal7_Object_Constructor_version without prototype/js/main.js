...
var Blog = function(str, date){
            ...
            //create a toSring fn inside the constructor for example of how to do 
            //just console log the date info in this fn

            this.toString = function(){
                console.log(
                    //  "{"  opening of block char

                    "[" + (this.date.getMonth() + 1 ) +"/" +
                    this.date.getDate() + "/" +
                    this.date.getFullYear() + "]" +  //] block char
                    this.body  
                    );          //remember this little fn is just going to console log the info we already have displaying on the web page
            };
};
/************************************************************************
